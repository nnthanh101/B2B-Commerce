---
title: Quickstart
description: Run the full B2B-Commerce stack locally in Docker in under 10 minutes.
sidebar_position: 2
tags: [quickstart, docker, local-dev]
source_refs:
...
- **Add AWS resources**: See `infra/terraform/` and [ADR-015](./architecture/adrs/ADR-015-local-first-terraform-iac.md)
- **Deploy to staging**: Planned Phase 3 (v0.3 milestone)

## Support

Questions? Check the [README](https://github.com/nnthanh101/B2B-Commerce) for links to community resources and support contacts.
