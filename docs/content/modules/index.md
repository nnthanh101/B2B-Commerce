...
| [Entity: Invite Module](./invite-module.md) | `b2b_invite` | Token-based employee invite + onboarding flow |
...
graph LR
    ...
    Invite["Invite Module\n(b2b_invite)"] -->|"company_id FK\nadmin issues invite"| Company
