---
title: "CEO Reel Narration — Cart to Quote to Approval"
description: Outcome-driven narration script for the CEO reel (Maria/David, 6 beats). Feature-accurate to real on-screen values.
sidebar_position: 10
tags: [demo, narration, ceo-reel, cart-to-quote, approval]
source_refs:
